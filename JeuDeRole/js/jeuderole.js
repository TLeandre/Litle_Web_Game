        ...
        while ( nbpredef === 0 ) {
            ...
            this.classe = defclasse;
              ...
              if ( this.classe === "1" ){
                 ...
                 this.xpmax = 300;
                 this.nivcachette = 75;
                 this.attack1 = "nom d'attaque a def";
                 this.attack2 = "nom d'attaque a def";
                 this.attack3 = "nom d'attaque a def";
                 this.attack4 = "nom d'attaque a def";
                 nbpredef = 1 ;
            ...
            if ( cible.esquive === 1 ) {
                ...
                if ( cible.contreattaque === 1 ) {
                    ...
                    while( nb50 === 0 ) {
                        ...
                        console.log(this.nom + " detient " + this.mana + " de mana pour attaquer");
                        console.log(this.attack1 + ", coute 0 de mana : 1");
                        console.log(this.attack2 + ", coute 3 de mana : 2");
                        console.log(this.attack3 + ", coute 6 de mana : 3");
                        console.log(this.attack4 + ", coute 9 de mana : 4");
                        console.log("--------------------");
                        var attacke = prompt("Quel attaque voulez-vous effectuer ? ");
                        ...
                        if ( attacke === "1" ) {
                            ...
                            if ( this.mana >= 3 ) {
                                ...
                                console.log("Tu na pas assez de mana pour faire cette attaque.");
                                console.log("--------------------");
                            ...
                            if ( this.mana >= 9 ) {
                                ...
                                degats = this.force * 5 / 2 ;
                                console.log(this.nom + " fait " + degats + " de dégats à " + cible.nom);
                                cible.sante = cible.sante - degats;
                                nb50 = 1 ;
                                this.mana = this.mana - 9;
                            ...
                            console.log("Désoler mais l'action que vous voulez effectuer n'est pas disponible.");
                            console.log("--------------------");
...
var Objets = {
        ...
        nom : "",
        competence : 0,  // force, resistance, 
        level : 0,
    
    definir : function (joueuractif) {
        
        var def = hasard(1, 100);
        if ( def > 50 ) {
